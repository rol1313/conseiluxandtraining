        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-6 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-text-dark mb-1">Niveau *</label>
              ...
              <div>
                <label className="block text-sm font-medium text-text-dark mb-1">Couleur de la carte</label>
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-6 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-text-dark mb-1">Catégorie *</label>
              ...
              {activeCat && activeCat.subcategories.length > 0 && (
                <div>
                  <label className="block text-sm font-medium text-text-dark mb-1">Sous-catégorie</label>
