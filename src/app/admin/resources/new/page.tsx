    ...
    <main className="min-h-screen bg-gray-50">
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-text-dark font-montserrat">Nouvelle ressource</h1>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {form.type === "PRESSE" && (
                <div>
                  ...
                  <input type="text" name="speaker" value={form.speaker} onChange={handleChange}
                    placeholder="Ex: Le Monde, Les Echos..."
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-primary text-sm" />
                </div>
              )}
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-text-gray text-sm mt-1">Publier immédiatement ou sauvegarder en brouillon</p>
              </div>
