...
import { Search, User, ArrowRight, Mic, X } from "lucide-react";
...
export default function InterviewsPage() {
  ...
  useEffect(() => {
    fetch("/api/resources?type=INTERVIEW")
      .then((res) => res.json())
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
              Découvrez les témoignages et interviews de nos experts et apprenants.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-text-gray">
                <span className="font-bold text-primary">{filtered.length}</span> interview
            ...
            {filtered.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filtered.map((resource, index) => (
                  ...
                  >
                    <Link href={`/interviews/${resource.slug}`}>
                      <motion.div
                        whileHover={{ y: -8 }}
                      ...
                      >
                        <div className="h-48 overflow-hidden">
                          {resource.image ? (
                            ...
                            <div className="w-full h-full bg-gradient-to-br from-orange to-orange-dark flex items-center justify-center">
