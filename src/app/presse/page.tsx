...
import { Search, ArrowRight, Newspaper, ExternalLink, X } from "lucide-react";
...
export default function PressePage() {
  ...
  useEffect(() => {
    fetch("/api/resources?type=PRESSE")
      .then((res) => res.json())
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
              Retrouvez toutes nos apparitions dans les médias et revues de presse.
            </p>
            ...
            <form onSubmit={handleSearch} className="max-w-xl mx-auto relative">
              ...
              <input
                type="text"
                placeholder="Rechercher un article de presse..."
                value={searchInput}
                onChange={(e) => {
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-text-gray">
                <span className="font-bold text-primary">{filtered.length}</span> article
            ...
            {filtered.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filtered.map((resource, index) => (
                  ...
                  >
                    <Link
                      href={resource.link ?? `/presse/${resource.slug}`}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="p-5 flex-1 flex flex-col">
                          {resource.speaker && (
                            <span className="text-xs text-orange font-medium mb-2">{resource.speaker}</span>
                          )}
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                            ...
                            <span className="flex items-center gap-1 text-orange text-sm font-medium">
                              {resource.link
                                ...
                                : <><ArrowRight className="w-4 h-4" /> Lire</>
                              }
                            </span>
                          </div>
                        </div>
