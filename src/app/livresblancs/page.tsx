...
import { Search, ArrowRight, BookOpen, Download, X } from "lucide-react";
...
export default function LivresBlancsPage() {
  ...
  useEffect(() => {
    fetch("/api/resources?type=LIVRE_BLANC")
      .then((res) => res.json())
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
              Téléchargez nos livres blancs et guides pratiques sur la formation professionnelle.
            </p>
            ...
            <form onSubmit={handleSearch} className="max-w-xl mx-auto relative">
              ...
              <input
                type="text"
                placeholder="Rechercher un livre blanc..."
                value={searchInput}
                onChange={(e) => {
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-text-gray">
                <span className="font-bold text-primary">{filtered.length}</span> livre
                {filtered.length > 1 ? "s" : ""} blanc{filtered.length > 1 ? "s" : ""} trouvé{filtered.length > 1 ? "s" : ""}
                {searchTerm && (
            ...
            {filtered.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filtered.map((resource, index) => (
                  ...
                  >
                    <Link href={`/livresblancs/${resource.slug}`}>
                      <motion.div
                        whileHover={{ y: -8 }}
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                            ...
                            {resource.link ? (
                              <a
                                ...
                                className="flex items-center gap-1 text-orange text-sm font-medium"
                              >
